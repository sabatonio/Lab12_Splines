...
{
ShowMessage("Это проект, который реализует сплайны, которые можно перемещать по окну приложения");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Help1Click(TObject *Sender)
{
	  ShowMessage("Данный проект по машинной графике выполнен студентом группы 12001801 Субботиным Антоном Андреевичем ");
}
//---------------------------------------------------------------------------
